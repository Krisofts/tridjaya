        ...
        return [
            ...
            [
                ...
                'subItems' => [
                    ...
                    ['name' => 'Reports', 'path' => '/crm/reports/users'],
...
{
    $current = request()->path(); // contoh: crm/leads/create
    $target = trim($path, '/');   // contoh: crm/leads
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
           ...
           'crm' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
