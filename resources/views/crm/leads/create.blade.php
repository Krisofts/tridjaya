...
<div class="mx-auto max-w-(--breakpoint-2xl) p-4 pb-20 md:p-6 md:pb-6">
    ...
    <div class="flex flex-wrap items-center justify-between gap-3 pb-6">
        <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90">Tambah Prospek</h2>
        <nav>
            <ol class="flex items-center gap-1.5">
                ...
                <li class="text-sm text-gray-800 dark:text-white/90">Tambah Prospek</li>
            </ol>
        </nav>
    </div>
    ...
    <form action="{{ route('crm.leads.store') }}" method="POST">
        ...
        <div class="space-y-6">
            ...
            <div
                ...
                x-data="{
                    provinceCode: @js(old('province_code')),
                    cityCode:     @js(old('city_code')),
                    districtCode: @js(old('district_code')),
                    cities:       {},
                    districts:    {},

                    async loadCities() {
                        this.cities = {}; this.districts = {};
                        this.cityCode = ''; this.districtCode = '';
                    ...
                    async loadDistricts() {
                        this.districts = {}; this.districtCode = '';
                ...
                x-init="
                    if (provinceCode) loadCities();
                    $watch('provinceCode', () => loadCities());
                    $watch('cityCode', () => loadDistricts());
                "
            >
                <div class="border-b border-gray-200 px-6 py-4 dark:border-gray-800">
                ...
                <div class="p-4 sm:p-6">
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select name="province_code" x-model="provinceCode" @change="loadCities()"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <select name="city_code" x-model="cityCode" @change="loadDistricts()" :disabled="Object.keys(cities).length === 0"
                ...
                <div class="p-4 sm:p-6">
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3">
                        ...
                        <x-form.select.select-with-label
                            ...
                            :required="true"
                            hint="Pilih Cash atau Kredit sesuai rencana pembelian."
                            :options="$pipelines"
