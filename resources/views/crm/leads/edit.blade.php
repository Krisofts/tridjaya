...
<x-common.page-breadcrumb pageTitle="Edit Lead" />
...
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
    ...
    <div class="border-b border-gray-200 px-6 py-5 dark:border-gray-800">
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Update prospect information in your CRM pipeline.
        </p>
        ...
        <div class="flex items-center justify-end gap-3 border-t border-gray-200 px-6 py-4 dark:border-gray-800">
            ...
            <button type="submit"
                ...
                <svg xmlns="http://www.w3.org/2000/svg"
                     ...
                     fill="none">
                    <path
                        d="M16.667 10V14.1667C16.667 15.0871 15.9208 15.8333 15.0003 15.8333H5.00033C4.07985 15.8333 3.33366 15.0871 3.33366 14.1667V5.83333C3.33366 4.91286 4.07985 4.16667 5.00033 4.16667H11.667"
                        stroke="currentColor"
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path
                        d="M15 2.5V7.5M17.5 5H12.5"
                        stroke="currentColor"
                        stroke-width="1.5"
                        stroke-linecap="round"
                        stroke-linejoin="round" />
