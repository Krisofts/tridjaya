    ...
    <tbody class="divide-y divide-gray-100 dark:divide-white/[0.05]">
        ...
        <tr>
            ...
            <td class="p-4 whitespace-nowrap">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-400">                        {{ $lead->name }}</span>
            </td>
            ...
            <td class="p-4 whitespace-nowrap">
                @php
                $temperature = strtolower($lead->stage->temperature ?? '');

                $type = match ($temperature) {
                'hot'       => 'error',
                'warm'      => 'warning',
                'cold'      => 'info',
                'customer'  => 'success',
