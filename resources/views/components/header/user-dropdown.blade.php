...
<div
    class="flex h-11 w-11 items-center justify-center rounded-full bg-blue-600 text-sm font-bold text-white shadow-sm"
>
    {{ auth()->user()->initials }}
</div>
        </span>
...
<form method="POST" action="{{ route('logout') }}">
    ...
    <a
        ...
        @click.prevent="$el.closest('form').submit(); closeDropdown()"
    >
        <span class="text-gray-500 group-hover:text-gray-700 dark:group-hover:text-gray-300">
