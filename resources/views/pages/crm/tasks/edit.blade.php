{{-- resources/views/pages/crm/tasks/edit.blade.php --}}
@extends('layouts.app')
...
<div class="flex items-center justify-between mb-6">
    <h1 class="text-xl font-bold text-gray-900 dark:text-white">Edit Task</h1>
...
<form method="POST" action="{{ route('crm.tasks.update', $task) }}">
    @csrf
    @method('PUT')
