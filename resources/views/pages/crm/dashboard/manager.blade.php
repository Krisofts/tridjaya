...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-4">
        <div class="flex items-center justify-between mb-3">
            <p class="text-xs font-medium text-gray-500 dark:text-gray-400">Nilai Won Bulan Ini</p>
            <div class="w-8 h-8 bg-yellow-100 dark:bg-yellow-900/30 rounded-lg flex items-center justify-center">
                <svg class="w-4 h-4 text-yellow-600 dark:text-yellow-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
            </div>
        </div>
        <p class="text-lg font-bold text-gray-900 dark:text-white">
            Rp {{ number_format($stats['won_value_month'], 0, ',', '.') }}
        </p>
        @if($stats['tasks_overdue_team'] > 0)
            <p class="text-xs text-red-500 mt-1">⚠ {{ $stats['tasks_overdue_team'] }} task tim terlambat</p>
        @endif
    </div>
