{{-- resources/views/pages/crm/leads/create.blade.php --}}
@extends('layouts.app')
...
<nav class="flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400 mb-5">
    ...
    <span class="text-gray-800 dark:text-white font-medium">Tambah Lead</span>
</nav>

<div class="flex items-center justify-between mb-6">
    <h1 class="text-xl font-bold text-gray-900 dark:text-white">Tambah Lead Baru</h1>
